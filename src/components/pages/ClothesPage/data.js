export const data = [
    ...
    
    {
        ...
        stamp: 'Linen Shorts',
        text: 'In shorts of color of clear sky designers have provided everything that is appreciated comfortable and comfortable summer clothes. Strong linen fabric supports the necessary thermoregulation and is felt pleasantly on the body. Brand: Kiton; Composition: Linen: 100%; Country of manufacture: Italy. Waist circumference:',
        type: 'Shirts',
        sex: 'Male',
        size: 102,
        cost: 750,
