export const data = [
    ...
    
    {
        ...
        text: 'A two-sided coat from the autumn-winter collection will allow experimenting with images. In dry cool weather. Brand: Kiton; Composition: Cashmere: 9%; Wool: 89%; Polyamide: 2%; Lining-polyester: 100%; Finish-leather: 100%; Country of manufacture: Italy. Chest girth:',
        type: 'Outrwear',
        sex: 'Male',
        size: 118,
        cost: 800,
    ...
    
    {
        ...
        stamp: 'Grey trousers',
        text: 'Grey trousers from the spring-summer collection will not be inferior to joggers in creating a comfortable everyday image. It is all about the wide elastic belt and the choice of material. Brand: Kiton; Composition: Cotton: 60%; Lyocell: 39%; Elastane (Polyurethane): 1%; Country of manufacture: Italy. Waist circumference:',
        type: 'Pants',
        sex: 'Male',
        size: 76,
        cost: 790,
    ...
    
    {
        ...
        text: 'Kargo has long since parted with a military past, so the beige model does not require army adjustment and rhymes peacefully with everyday things. Brand: Kiton; Composition: Linen: 65%; Cotton: 34%; Elastane (Polyurethane): 1%; Country of manufacture: Italy. Waist circumference:',
        type: 'Pants',
        sex: 'Male',
        size: 86,
        cost: 780,
    ...
    
    {
        ...
        text: 'A black miniskirt with a wide yoke is sewn from an almost muted smooth fabric that is well-breathable. One of the helmets is decorated with the white logo of the stamp, founded by Hugo Ferdinand Bosse. Brand: HUGO; Composition: Polyester: 64%; Viscose: 31%; Elastane: 5%; Country of manufacture: Romania. Waist circumference:',
        type: 'Skirts',
        sex: 'Female',
        size: 74,
        cost: 700,
    ...
    
    {
        ...
        stamp: 'Denim skirt',
        text: 'At the show, an extremely short beige skirt was combined with a jacket and jeans to tone, and we offer to wear with a black T-shirt and boots, completing the image of a trench coat. Brand: Diesel; Composition: Cotton: 100%; Country of manufacture: Italy. Waist circumference:',
        type: 'Skirts',
        sex: 'Female',
        size: 83,
        cost: 720,
...

    {
        ...
        stamp: 'Cotton shorts',
        text: 'The masters of the stamp sewed dark blue shorts from smooth, pleasant to the touch cotton knitwear. The straight model sits comfortably on the figure, without restricting the freedom of movement. Brand: Kiton; Composition: Cotton: 100%; Country of manufacture: Italy. Waist circumference:',
        type: 'Shorts',
        sex: 'Male',
        size: 104,
        cost: 730,
...

    {
        ...
        stamp: 'Cotton shorts',
        text: 'Light grey shorts with wide waistband-cushion stitched from soft elastic cotton jersey, which is great for air flow, preventing overheating even on hot days. Brand: Kiton; Composition: Cotton: 100%; Country of manufacture: Italy. Waist circumference:',
        type: 'Shorts',
        sex: 'Male',
        size: 80,
        cost: 730,
...

    {
        ...
        stamp: 'Silk blouse',
        text: 'The subtle bluish shade of this blouse rhymes with long ribbons tied with a voluminous bow at the front. Giorgio Armani chose a virtually weightless silk crepe for his spring-summer collection. Brand: Giorgio Armani; Composition: Silk: 100%; Country of manufacture: Italy. Chest girth:',
        type: 'Blouses',
        sex: 'Female',
        size: 108,
        cost: 930,
...

    {
        ...
        stamp: 'Beige bomber',
        text: 'A beige bomber with a stand-up collar and an oncoming zipper was made from a soft, airtight Performa fabric that did not interfere with air circulation. Brand: Brioni; Composition: Polyester: 100%; Country of manufacture: Italy. Chest girth:',
        type: 'Other',
        sex: 'Male',
        size: 124,
        cost: 925,
...

    {
        ...
        stamp: 'Black vest',
        text: 'When creating a clean black vest from the spring-summer collection, designers of the brand relied on the material. Brand: Ermenegildo Zegna; Composition: Polyester: 100%; Country of manufacture: Romania. Chest girth:',
        type: 'Other',
        sex: 'Male',
        size: 106,
        cost: 928,
